...
_MOCK_NOTIFICATIONS = [
    ...
    },
    {
        ...
        "message": (
            "Alert FR-007 (Compliance Violation — minor schema version) "
            "cleared as false positive. No action required."
        ),
        "is_read": True,
        "action_url": "/fraud-intelligence",
    ...
    },
    {
        ...
        "message": (
            "Executive payroll batch processed. 1 critical alert "
            "(FR-012: potential tax evasion via offshore entity). "
    ...
    },
    {
        ...
        "message": (
            "Overall risk score decreased 2.3% this month. "
            "Finance department showing improvement. "
            "Operations now flagged as emerging risk area."
        ),
        "is_read": True,
        "action_url": "/ai-insights",
